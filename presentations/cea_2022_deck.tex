...
\usepackage{graphicx,hyperref,url,fes}
...
\begin{frame}{Carbon Pricing Policy and Power Generation Sources}
   \tikz [remember picture,overlay]
    \node[yshift=-.5cm,xshift=0cm] at (current page.center)
       {\includegraphics[width=.9\paperwidth]{../../alberta_power/images/gen_ghg_price.png}}; \vspace{1cm}
   \vfill
\end{frame}
...
\begin{frame}{Carbon Intensity of Alberta Power}
   \tikz [remember picture,overlay]
    \node[yshift=-.5cm,xshift=0cm] at (current page.center)
       {\includegraphics[width=.9\paperwidth]{../../alberta_power/images/monthly_ghg_mwh.png}}; \vspace{1cm}
   \vfill
\end{frame}
