...
z<-subset(z,(prod<=5)|(prod>=6))
z<-subset(z,(prod<=10)|(prod>=11))
z<-subset(z,(prod<=15)|(prod>=16))
z<-subset(z,(prod<=20)|(prod>=21))
z<-subset(z,(prod<=25)|(prod>=26))
z<-subset(z,(prod<=30)|(prod>=31))
